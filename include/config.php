<?
	...
	$GLOBALS['cfg']['site_name'] = 'branch-in';
	...
	$GLOBALS['cfg']['abs_root_url']		= 'http://'.($_SERVER['SERVER_NAME'] ? $_SERVER['SERVER_NAME'] : 'branch-in.com').'/';
	...
	$GLOBALS['cfg']['email_from_name']	= 'branch-in';
	$GLOBALS['cfg']['email_from_email']	= 'admin@branch-in.com';
	$GLOBALS['cfg']['auto_email_args']	= '-fadmin@branch-in.com';
